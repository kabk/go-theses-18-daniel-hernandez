...
var reproduce = function reproduce() {
	...
	var calculateOffspring = function calculateOffspring() {
		...
		var maxEliteOffspring = generationSpecimens - generationSpecimens / 4;
	...
	for (var j = offspringNo; j < generationSpecimens; j++) {
		...
		if (j % 2 === 0) {
			// half of times push new dna, other half get from unfit parents
...
var mutateSingleDNA = function mutateSingleDNA(arr, ind) {
	...
	var mutationStrength = 15; // Lower numbers result in more drastic changes
